...
summarySection.appendChild(Text("p", "Choose a short video to summarize", "lighter-text"))

main.appendChild(AppName());
main.appendChild(form);
main.appendChild(summarySection);
// main.appendChild(Text("p", "Choose a short video to summarize", "lighter-text"))
