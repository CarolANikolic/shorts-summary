...
To work with the code, you will need, before you begin, to install on your machine: NodeJs, Git and to have a source-code editor such as [VSCode](https://code.visualstudio.com).
